...
GOOGLE_CLIENT_ID = "707304466648-fdp7lve40dn2rg4ckp1p8alg623crsgn.apps.googleusercontent.com"
    ...
    if 'user_id' in session and 'user_name' in session:
        try:
            ...
            if file and allowedExtension(file.filename):
                ...
                result = None               
                result = resumeFetchedData.insert_one({"UserId":ObjectId(session['user_id']),"NAME":value_name,"JOB POST":value_jobpost,"SKILLS": value_skills,"CERTIFICATION": value_certification,"EXPERIENCE":value_experience,"EDUCATION":value_education,"LOCATION":value_location,"Appear":0,"ResumeTitle":filename,"ResumeAnnotatedData":resume_data_annotated,"ResumeData":text_of_resume})                
